...
export const WHATSAPP_DEFAULT_MSG =
  "ممكن أعرف تفاصيل وأسعار هاسيندا راس الحكمة";
...
export const HACIENDA = {
  ...
  whatsappPresets: {
    ...
    form_followup:
      "بعت استمارة هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
    unit_apartment:
      "مهتم بستوديو في هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
    unit_chalet:
      "مهتم بشاليه في هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
    unit_twin:
      "مهتم بتوين هاوس في هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
    unit_villa:
      "مهتم بفيلا فائقة الفخامة في هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
    unit_branded:
      "مهتم بـ Branded Residences في هاسيندا راس الحكمة — محتاج التفاصيل والأسعار.",
  } as const,
} as const;
